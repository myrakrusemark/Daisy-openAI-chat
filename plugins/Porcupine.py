...
if platform.system() == "Windows":
    keyword_paths = ["plugins/porcupine_models/daisy-daisy_en_windows_v2_1_0.ppn", "plugins/porcupine_models/hey-daisy_en_windows_v2_1_0.ppn"]
elif platform.system() == "Linux":
    keyword_paths = ["plugins/porcupine_models/daisy-daisy_en_raspberry-pi_v2_1_0.ppn", "plugins/porcupine_models/hey-daisy_en_raspberry-pi_v2_1_0.ppn"]
else:
